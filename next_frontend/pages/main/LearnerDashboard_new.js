...
function ShowLearningConversationForAChapter({
  chapterText,
  chapterEndReached,
  onLearnerEvent,
  backToModulesClicked,
  learnerQuizProgress,
}) {
...
function ShowLearningConversationForAQuiz({
  chapterText,
  chapterEndReached,
  onLearnerEvent,
  ...
  function onLearnerEvent(eventDetails) {
    ...
    switch (eventDetails.subtype) {
      ...
      case "changemissionstatus":
        changeMissionStatusForTheUser(
          eventDetails.data.missionid,
          eventDetails.data.newstatus
        );
  ...
  function onChapterClicked(chapter) {
    ...
    (async function () {
      ...
      setComponentState((componentState) => {
        if (componentState == "chapterinprogress")
      ...
      {session && (
        <DashboardAppBar signedUser={session.user}>
          ...
          {componentState == "showretryquiz" && (
            <ShowLearningConversationForAQuiz
              chapterText={chapterText}
