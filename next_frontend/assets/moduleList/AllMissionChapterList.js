export const ZacobiaModuleList = [
    ...
    {id:1,name:"Let's Break It Down",    fileName:"ZacobiaMission/2_BreakingIntoSteps.js",    description: "Breaking down a problem into smaller parts",             topicsCovered:"Problem solving",image:"BreakItDown.png"},
    {id:2,name:"Statements and Syntax",  fileName:"ZacobiaMission/3_ProgramStmtsSyntax.js",   description: "Statements and syntax in computer programming",             topicsCovered:"Statements, Syntax",image:"StmtsAndSyntax.png"},
    {id:3,name:"Let's get help",         fileName:"ZacobiaMission/4_ModuleImport.js",         description: "Modules and using them in Python", topicsCovered:"Python Import Statement",image:"Help.png"},
    {id:4,name:"Reading light level",    fileName:"ZacobiaMission/5_LightLevel.js",           description: "Measure light level using Micro:bit",topicsCovered:"Calling API",image:"ReadLightLevel.png"},
    {id:5,name:"Display on and off",fileName:"ZacobiaMission/6_ShowClearDisplay.js",description: "APIs to switch on and off Microbit's display",topicsCovered:"Switching on and off display",image:"ShowAndClearDisplay.png"},
    {id:6,name:"Conditions",fileName:"ZacobiaMission/7_Conditions.js",description: "Conditional statements and their use",topicsCovered:"Conditional statements",image:"Conditions.png"},
    {id:7,name:"Blocks",fileName:"ZacobiaMission/8_Blocks.js",description: "Python blocks and why they are important",topicsCovered:"Indentation, Blocks",image:"Blocks.png"},
    {id:8,name:"Learning About If",fileName:"ZacobiaMission/9_IfStatement.js",description: "Conditions with If statement",topicsCovered:"If statement in Python",image:"LearnIf.png"},
    {id:9,name:"Switch display only if",fileName:"ZacobiaMission/10_ConditionOnOffDisplay.js",description: "Conditionally switch on and off a display",topicsCovered:"If statement implementation",image:"ConditionOnOff.png"},
    {id:10,name:"Loops - Doing again",fileName:"ZacobiaMission/11_WhileLoop.js",description: "Loops and using While for a loop in Python",topicsCovered:"Problem Introduction",image:"Loops.png"},
    {id:11,name:"Take rest with sleep",fileName:"ZacobiaMission/12_Sleep.js",description: "Adding a dealy using Python sleep statement",topicsCovered:"Sleep statement in Python",image:"Sleep.png"},
    {id:12,name:"Yay!!! We have done it",fileName:"ZacobiaMission/13_Conclusion.js",description: "Walkthrough of the topcics covered in the mission",topicsCovered:"Problem Introduction",image:"Conclusion.png"},
];
