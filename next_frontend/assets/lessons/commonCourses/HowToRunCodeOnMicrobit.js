...
const haveMicroBit = [
    ...
    {type: "TM", message: "Anytime you want to make a change, just change the code in the editor and presse <b>Sent to Microbit</b> button as we did in step 4"},
    {id:1, type: "ack"},
    {id:1, type: "clearpage"},
    {id:1, type: "showpage"},
...
export let LessonText = [
   ...
   // {id:1, type: "image", path:"/lessonImages/Blocks.png", altText:"testImage"},
    ...
    {id:5, type: "TM", message: "You can either run the code on simulator or on an actual Microbit if you own one"},
