...
export const LessonText = [
    ...
    {id:12, type:"TM", message: "And we use API or functions in modules to get help"},
    ...
    {id:12, type:"TM", message: "Bascially, module is collection of functions and variables that can be reused by other Python programs"},
    {id:1, type: "ack", message:"Click next to proceed"},
    {id:1, type: "clearpage"},
    {id:1, type: "showpage"},
...
def displayNumbersBetween (startNumber, endNumber):
    ...
    {id:1, type: "TM", message:"So in our case the import statement will be \'import NumberDisplayModule\'"},
    {id:1, type: "ack", message:"Click next to proceed"},
    {id:1, type: "clearpage"},
    {id:1, type: "showpage"},
    {id:1, type: "TM", message:"Now we have the right module or help imported"},
    {id:12, type:"TM", message: "Now we need to use the service, API or function of the module"},
    {id:12, type:"TM", message: "Remember from Zacoiba mission, the value to use the help is: modulename.apiname(parameter1, parameter2 ...)"},
