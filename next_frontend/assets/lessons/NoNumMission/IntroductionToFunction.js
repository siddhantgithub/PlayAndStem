...
export const LessonText = [
    ...
    {id:12, type:"TM", message: "Also, block of code can use the paramaters listed in the function definition line as a variables are automatically created for the parameters"},
    {id:1, type: "ack", message:"Click next to proceed"},
    {id:1, type: "clearpage"},
    {id:1, type: "showpage"},
