...
export const LessonText = [
    ...
    {id:1, type: "donothing"},
    {id:15, type: "TM", message: "In this mission, we will use APIs to get information from Micro:bit"},
    {id:1, type: "ack", message:"Click next to proceed"},
    {id:1, type: "clearpage"},
    {id:1, type: "showpage"},
    ...
    {id:1, type: "clearpage"},
    {id:1, type: "showpage"},
    {id:11, type: "TM", message: "We now know how to get the light level from Micro:bit. In the next chapter, we will learn to switch on or off the light depending on the light level"},
    {id:13, type: "donothing"},
