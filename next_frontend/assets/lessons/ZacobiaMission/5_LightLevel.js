...
export const LessonText = [
    ...
    {id:15, type: "TM", message: " API provide a way for computer programs to share informaion with each other"},
    {id:1, type: "donothing"},
    {id:15, type: "TM", message: "In this mission, we will use  API to get information from Microbit"},
    {id:1, type: "ack", message:"Click next to proceed"},
    {id:1, type: "clearpage"},
    {id:1, type: "showpage"},
    {id:15, type: "TM", message:"To better understand API, let's take the example of a chef"},
    {id:12, type:"TM", message: "Now a chef can make multiple dishes such as pasta, salad, etc...; You can imagine each of these dishes as different  services"},
    {id:1, type: "donothing"},
