export const LessonText = [
    ...
    {id:1, type: "clearpage"},
    {id:1, type: "showpage"},
    {id:15, type: "TM", message: "What are comments in a programming language?"},
    ...
    {id:15, type: "TM", message: "Apart from writing down your recipe, you would also like to add comments to the recipe, such as, even if you cook for 5 more minutes it is fine, etc.."},
    {id:1, type: "donothing"},
...
while True:
    ...
    {id:12, type:"TM", message: "We not only solved Zacobians' light problem but also learned several new things along the way"},
    {id:1, type: "donothing"},
