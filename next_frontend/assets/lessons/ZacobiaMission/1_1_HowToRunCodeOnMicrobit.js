...
const haveMicroBit = [
    ...
    {type: "TM", message: "Playing with a Microbit is a lot of fun!"},
    {id:1, type: "ack"},
    {id:1, type: "clearpage"},
    {id:1, type: "showpage"},
    ...
    {type: "TM", message: "Step 4: Run the code on Microbit"},
    {id:1, type: "ack"},
    {id:1, type: "clearpage"},
    {id:1, type: "showpage"},
...
export let LessonText = [
   ...
   // {id:1, type: "image", path:"/lessonImages/Blocks.png", altText:"testImage"},
    {id:5, type: "TM", message: "Hi, in this chapter we will learn how to run and test your code on Microbit"},
    {id:6, type: "donothing"},
    {id:5, type: "TM", message: "You can either run the code on the simulator or on an actual Microbit"},
