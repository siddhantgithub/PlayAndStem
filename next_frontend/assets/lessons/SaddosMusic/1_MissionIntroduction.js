...
const haveMicroBit = [
    ...
    {type: "TM", message: "Anytime you want to make a change, just change the code in the editor and press <b>Sent to micro:bit</b> button as we did in step 4"},
    {id:1, type: "ack"},
    {id:1, type: "clearpage"},
    {id:1, type: "showpage"},
...
const runMicrobitCodeHelpText = [
   ...
   // {id:1, type: "image", path:"/lessonImages/Blocks.png", altText:"testImage"},
    ...
    {id:6, type: "donothing"},
    {id:5, type: "TM", message: "You can either run the code on simulator or on an actual Micro:bit"},
...
export const LessonText = [
    ...
    {id:12, type: "TM", message: "Copy the code below and run it on your Micro:bit"},
