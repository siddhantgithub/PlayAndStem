...
const variableLightLevelResponseAction = {
    correct: ["Great!", "Now you know how to call  API and store values in a variable", "Press Next To proceed further"],
...
export let LessonText1 = [
    ...
    {id:12, type: "TM", message: "We can help Zacobians save energy by building lights that automatically switch off during the day by using Microbit controller"},
    {id:1, type: "ack", message:"Click next to solve Zacobian's problems"},
    {id:1, type: "clearpage"},
    {id:1, type: "showpage"},
    {id:13, type: "TM", message: "To use Microbit, first we need to learn how to talk to it"},
    ...
    {id:11, type: "TM", message: "Similarly, statements have to use the right order or syntax so that computers can understand them"},
    {id:1, type: "ack", message:"Next"},
    {id:1, type: "clearpage"},
    {id:1, type: "showpage"},
    ...
    {id:15, type: "TM", message: "Remember modules have different skills or  API or functions"},
    {id:15, type: "TM", message: "Here we will use  function called \'read_light_level()\'"},
    {id:1, type: "ack", message:"Click next to proceed"},
    {id:1, type: "clearpage"},
    {id:1, type: "showpage"},
    {id:15, type: "TM", message:"To better understand  function, let's again take the example of a chef. Imagine a chef as a module"},
    {id:12, type:"TM", message: "Now a chef can make multiple dishes such as pasta, and spinch salad. You can imagine each of these dishes as different  services"},
    ...
    {id:12, type:"TM", message: "Similarly we need to store the light level we get from API to use it later"},
    ...
    {id:12, type:"TM", message: "Similarly for display API you also need to tell what it should display"},
    {id:1, type: "ack", message:"Click next to proceed"},
    {id:1, type: "clearpage"},
    {id:1, type: "showpage"},
    ...
    {id:15, type: "TM", message: "We will get help from modules through  API. You can imagine API as a way to tell what do you need"},
    {id:1, type: "ack", message:"Click next to proceed"},
    {id:1, type: "clearpage"},
    {id:1, type: "showpage"},
    {id:15, type: "TM", message:"To better understand, let's again go back to the example of chef"},
    {id:12, type:"TM", message: "Now imagine chef can make multiple dishes such as pasta, and spinch salad. You can imagine each of these dishes as different  services"},
    {id:12, type:"TM", message: "so if you have to order pasta, you will ask for Pasta service or API"},
    {id:12, type:"TM", message: "Similarly the display module in Microbit offers multiple services or API"},
    {id:12, type:"TM", message: "One of the  service is to get light level"},
    {id:12, type:"TM", message: "Now how do we use the  service, in Python we do that by following a syntax"},
