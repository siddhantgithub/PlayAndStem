...
export let LessonText_Guest = [
    ...
    // {id:1, type: "clearpage"},
    // {id:1, type: "showpage"},
   // {id:1, type: "video", path:"/lessonImages/Blocks.png", altText:"testImage", videoId:"qWCP_Wh82x0"},
   // {id:0, type: "TM", message:"For example, click the video below what we will make by completing Zacobia mission"},
   // {id:1, type: "ack"},
    {id:0, type: "TM", message:"Hey guest, welcome to StoryBotics."},
    {id:0, type: "TM", message:"My name is Cairo and I will be your buddy here"},
    {id:1, type: "ack"},
    {id:1, type: "clearpage"},
    {id:1, type: "showpage"},
    {id:0, type: "TM", message:"You know, I can speak in different voices"},
    {id:0, type: "TM", message:"You can select my voice in the pop up that I will open up now "},
    {id:0, type: "TM", message:"Please select the voice that works for you the best"},
    {type:"learnerevent", data: {type: "learnerevent", subtype: LearnerEventType.OpenCairoSetting, data:{missionid:0, newstatus:"Available"}}},
    {id:1, type: "ack"},
    {id:1, type: "clearpage"},
    {id:1, type: "showpage"},
    {id:0, type: "TM", message:"Anytime you want, you can also change the voice, volume, mute or unmute me or change the speed at which I speak by clicking on the icons above"},
    {id:1, type: "ack"},
    {id:1, type: "clearpage"},
    {id:1, type: "showpage"},
    {id:0, type: "TM", message:"I will now explain you what we will do in Storybotics"},
    {id:0, type: "TM", message:"Here, we will solve missions together. A mission is a problem that needs to be solved by completing a set of chapters"},
    {id:0, type: "TM", message:"Each chapter in a mission explains a concept in detail followed by a small quiz"},
    {id:1, type: "ack"},
    {id:1, type: "clearpage"},
    {id:1, type: "showpage"},
    {id:0, type: "TM", message:"While solving a mission, we will not only learn new things but also make some fun stuff"},
    {id:0, type: "TM", message:"For now, we have three missions to solve. You should be able to see them below"},
    {id:1, type: "ack"},
    {id:1, type: "clearpage"},
    {id:1, type: "showpage"},
    ...
    {type: "TM", message: "It is time to start \'Zacobian Lights\' mission"},
    {type: "TM", message: "Click on the mission in the section below or click next to begin"},
    {id:5, type: "TM", message: "Please note, since you are using a guest account, your progress will not be saved"},
    {id:1, type: "acksp", data: {type:"learnerevent", subtype:"loadmission", data:0}},
