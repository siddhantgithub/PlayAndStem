...
export let LessonText_Guest = [
    ...
    {id:1, type: "clearpage"},
    {id:1, type: "showpage"},
    {id:5, type: "TM", message: "One thing to note, since you are using a guest account, your progress will not be saved. To create an account, click <b>Create Account</b> from the top menu"},
    {id:1, type: "ack"},
    {id:1, type: "clearpage"},
    {id:1, type: "showpage"},
