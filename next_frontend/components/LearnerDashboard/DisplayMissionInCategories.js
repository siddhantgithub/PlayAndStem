    ...
    <Card sx={{ width: 220, height: 290, margin: 1 }}>
      <CardActionArea onClick={onMissionClick}>
        ...
        <CardContent>
          ...
          <Chip
            label={learnerMissionProgress}
            color={returnChipColor(learnerMissionProgress)}
            variant="outlined"
            sx={{ margin: 1 }}
          />
        </CardContent>
...
export default function DisplayMissionsInCategories({
  onMissionClicked,
  learnerMissionProgress,
}) {
                    ...
                    return (
                      learnerMissionProgress && (
                        <MissionCard
                          ...
                          learnerMissionProgress={
                            learnerMissionProgress[mission.id]
                          }
                          key={key}
